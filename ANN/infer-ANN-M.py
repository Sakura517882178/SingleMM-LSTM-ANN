...
if __name__ == "__main__":
    test_npz = "test_features.npz"
    trained_model = "checkpoints-AM-Uni/best_memristor_lstm_attn_ft.pth"
    
    preds, labels, acc = inference(test_npz, trained_model)
    
    # 保存到 CSV
    csv_file = "predictions.csv"
    with open(csv_file, mode='w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(["label", "prediction"])  # 表头
